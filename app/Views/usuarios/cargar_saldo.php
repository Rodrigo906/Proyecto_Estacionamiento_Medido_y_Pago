                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="<?= base_url('cargar-saldo') ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" style="margin-bottom: 3%; width: 50%;  font-size: .8rem; border-radius: 10rem; height: calc(1.5em + 1.3rem + 1.7px);padding: 0.375rem 0.75rem; background-color: #fff; color: #6e707e;border: 1px solid #d1d3e2;">
                                        ...
                                        <select class="form-control" style="width: 50%; font-size: .8rem; border-radius: 10rem; height: calc(1.5em + 1.3rem + 1.7px);padding: 0.375rem 0.75rem; background-color: #fff; color: #6e707e;border: 1px solid #d1d3e2;">
